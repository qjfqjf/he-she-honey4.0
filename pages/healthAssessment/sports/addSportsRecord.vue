<template>
  <view class="content">
    <z-nav-bar title="运动记录"></z-nav-bar>
    <public-module></public-module>
    <!-- 1、用餐分类 -->
    <view class="cate">
      <text class="cate-text">运动类别</text>
    ...
    <!-- 3、备注和时间 -->
    <view class="remarks">
      <textarea class="textarea" v-model="remarksValue" placeholder="添加备注" />
  ...
  export default {
    ...
    methods: {
      ...
      saveRecords(recordId){
        ...
        uni.navigateTo({
          url:'/pages/healthAssessment/sports/sportsRecord?recordId='+JSON.stringify(recordId)
        })
      }
    },
  }
