<template>
	<view class="wholebox">
		<!-- 背景图 -->
		<image class="bg-img" src="../../static/img/login/backgroundimg.png">
		</image>
		<view class="top-nev">
		...
		<view class="login-input">
			...
			<u-button @click="onsubmit" type="success" size="large" style="margin-top: 100rpx;color: #FFFFFF;background-color: #1fc7a3" ripple="true">立即登录</u-button>
		</view>
		...
		<view class="third-methods">
			<view class="wechatimg-box">
				<image src="../../static/icon/wechat2.png" @click="onWechatLog" style="display: block;margin: 0 auto;width: 100rpx; height: 100rpx;">
				</image>
			</view>
