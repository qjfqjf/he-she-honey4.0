<template>
	<view>
		...
		<view>
			<advisory :tab-list="tabList"/>
		</view>
	</view>
</template>

<script>
import advisory from "../componment/advisory";
import Advisory from "../componment/advisory.vue";
	export default {
		components: {Advisory},
		data() {
			return {
				tabList: [{name:'我的美容师'}, {name:'找机构'}]
			}
		},
		componments:{
			advisory
