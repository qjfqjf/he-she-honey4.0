	...
	export default {
		...
		methods: {
			...
			cancelBind() {
				...
				uni.closeBLEConnection({
					...
					success: function(res) {
						...
						uni.removeStorageSync(_this.deviceInfo.dName)
						_this.deviceInfo.deviceId = uni.getStorageSync(_this.deviceInfo.dName)
						uni.$emit('updateDevice', _this.deviceInfo)
						uni.$emit('updateDeviceStatus', 0)
					},
					fail: function(err) {
			...
			connect(data) {
				...
				_this.deviceInfo.deviceId = uni.getStorageSync(this.deviceInfo.dName)
				uni.showToast({
					title: '绑定成功',
				})
